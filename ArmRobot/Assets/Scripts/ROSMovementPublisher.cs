...
public class ROSMovementPublisher : Publisher<RobotMessageType>
{
    ...
    private void UpdateMessage()
    {
        ...
        message.forearm_target = robotController.joints[0].robotPart.GetComponent<ArticulationBody>().xDrive.target;
        message.shoulder_target = robotController.joints[1].robotPart.GetComponent<ArticulationBody>().xDrive.target;
        message.upper_arm_target = robotController.joints[2].robotPart.GetComponent<ArticulationBody>().xDrive.target;
