...
namespace Unity.Simulation
{
    ...
    public sealed class Manager
    {
        ...
        public NotificationDelegate LateShutdownNotication;
        ...
        private bool readyToQuit
        {
            get
            {
                ...
                var done = ((_finalUploadsDone && !ConsumptionStillInProgress()) ||
                            _shutdownTimer >= kMaxTimeBeforeShutdown);
                if (done)
                    LateShutdownNotication?.Invoke();
