...
namespace Unity.Simulation
{
    ...
    public static class CaptureCamera
    {
        ...
        )
        {
            ...
            {
                target1 = RenderTexture.GetTemporary(camera.pixelWidth, camera.pixelHeight);
                Blit(commandBuffer, cameraTargetTexture, ref target1, depthMaterial);
            }
            else
            {
            ...
            if (flipY)
            {
                ...
                Blit(commandBuffer,  ref target1, ref target2, new Vector2(1, -1), Vector2.up);
            }
        ...
        static void Blit(CommandBuffer commandBuffer, Texture texture, ref RenderTexture renderTexture, Material material)
        {
        ...
        static void Blit(CommandBuffer commandBuffer,  ref RenderTexture texture, ref RenderTexture renderTexture, Vector2 scale, Vector2 offset)
        {
            if (commandBuffer != null)
            {
